...
struct file_entry
{
   ...
   void* upage;                     /* the address of mapped pages */
...
struct thread
  {
    ...
    struct semaphore sema_load;			 /* control the logic of the child process and 
    ...
    struct list mapped_filelist;       /* list of mapped files. */
